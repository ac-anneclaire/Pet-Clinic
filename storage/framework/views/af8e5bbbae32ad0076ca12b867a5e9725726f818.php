...
<section id="servc">
	<h1>OUR SERVICES</h1>
		...
		<div class="row">
			<div class="img">
				<img src="<?php echo e(asset('img/chup.jpg')); ?>" style="width: 190px; height: 150px" />
			<h2>Check-Up</h2>
			...
			<br>
			<div class="img">
				<img src="<?php echo e(asset('img/dworm.jpg')); ?>" style="width: 190px; height: 150px" />
			<h2>Deworming</h2>
				<p>Deworming is used to cure and prevent diseases and their symptoms such as hook and roundworm infections.</p>
			</div>
			<div class="img">
				<img src="<?php echo e(asset('img/vacc.jpg')); ?>" style="width: 190px; height: 150px" />
				<h2>Vaccination</h2>
				...
				<div class="img">
					<img src="<?php echo e(asset('img/groom.jpg')); ?>" style="width: 190px; height: 150px" />
					<h2>Grooming</h2>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PetClinic\resources\views/appointment/index.blade.php ENDPATH**/ ?>